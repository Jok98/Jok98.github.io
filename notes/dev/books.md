...
## 3) Linux from the kernel upward

* [Linux From Scratch](https://www.linuxfromscratch.org/lfs/read.html)
* [How Linux Works](https://nostarch.com/howlinuxworks3)
* [Linux Kernel Programming](https://www.packtpub.com/en-ec/product/linux-kernel-programming-9781803232225?type=print)


## 4) Low-level programming: C

* [Learning C Salvatore Sanfilippo Antirez Redis](https://www.youtube.com/watch?v=HjXBXBgfKyk&list=PLrEMgOSrS_3cFJpM2gdw8EGFyRBZOyAKY)
...
* [Design Patterns](https://www.informit.com/store/design-patterns-elements-of-reusable-object-oriented-9780201633610)
...
* [Cryptography Engineering](https://onlinelibrary.wiley.com/doi/book/10.1002/9781118722367)


## 12) Containers, Kubernetes, SRE, observability
